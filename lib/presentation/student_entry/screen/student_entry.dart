    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () => GoRouter.of(context).pushReplacementNamed(HomeScreen.route), // Go back using GoRouter
        ),
      ),
                        ...
                        child: TextField(
                          decoration: InputDecoration(
                            ...
                            enabledBorder: UnderlineInputBorder(
                              borderSide: BorderSide(color: AppColors.textColor), // Bottom border when enabled
                            ),
                            focusedBorder: UnderlineInputBorder(
                              borderSide: BorderSide(color: AppColors.textColor, width: 2.0), // Bottom border when focused
                            ),
                          ),
                          onTap: (){
                      ...
                      child: GridView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return GestureDetector(
                            onTap: () {
                              Navigator.pop(context); // Close bottom sheet when an item is tapped
                            },
                            child: Padding(
                              padding:  EdgeInsets.all(8.0),
                              child: Container(
